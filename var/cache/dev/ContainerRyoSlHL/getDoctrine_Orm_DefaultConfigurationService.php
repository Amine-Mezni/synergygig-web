...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AttendanceRepository' => ['privates', 'App\\Repository\\AttendanceRepository', 'getAttendanceRepositoryService', true],
            'App\\Repository\\BookmarkRepository' => ['privates', 'App\\Repository\\BookmarkRepository', 'getBookmarkRepositoryService', true],
            'App\\Repository\\CallRepository' => ['privates', 'App\\Repository\\CallRepository', 'getCallRepositoryService', true],
            'App\\Repository\\CallSignalRepository' => ['privates', 'App\\Repository\\CallSignalRepository', 'getCallSignalRepositoryService', true],
            'App\\Repository\\ChatRoomMemberRepository' => ['privates', 'App\\Repository\\ChatRoomMemberRepository', 'getChatRoomMemberRepositoryService', true],
            'App\\Repository\\ChatRoomRepository' => ['privates', 'App\\Repository\\ChatRoomRepository', 'getChatRoomRepositoryService', true],
            'App\\Repository\\CommentRepository' => ['privates', 'App\\Repository\\CommentRepository', 'getCommentRepositoryService', true],
            'App\\Repository\\CommunityGroupRepository' => ['privates', 'App\\Repository\\CommunityGroupRepository', 'getCommunityGroupRepositoryService', true],
            ...
            'App\\Repository\\GroupMemberRepository' => ['privates', 'App\\Repository\\GroupMemberRepository', 'getGroupMemberRepositoryService', true],
            'App\\Repository\\InterviewRepository' => ['privates', 'App\\Repository\\InterviewRepository', 'getInterviewRepositoryService', true],
            ...
            'App\\Repository\\LeaveRepository' => ['privates', 'App\\Repository\\LeaveRepository', 'getLeaveRepositoryService', true],
            ...
            'App\\Repository\\PayrollRepository' => ['privates', 'App\\Repository\\PayrollRepository', 'getPayrollRepositoryService', true],
            'App\\Repository\\PostRepository' => ['privates', 'App\\Repository\\PostRepository', 'getPostRepositoryService', true],
            'App\\Repository\\ProjectMemberRepository' => ['privates', 'App\\Repository\\ProjectMemberRepository', 'getProjectMemberRepositoryService', true],
            ...
            'App\\Repository\\TrainingCertificateRepository' => ['privates', 'App\\Repository\\TrainingCertificateRepository', 'getTrainingCertificateRepositoryService', true],
            'App\\Repository\\TrainingCourseRepository' => ['privates', 'App\\Repository\\TrainingCourseRepository', 'getTrainingCourseRepositoryService', true],
            'App\\Repository\\TrainingEnrollmentRepository' => ['privates', 'App\\Repository\\TrainingEnrollmentRepository', 'getTrainingEnrollmentRepositoryService', true],
            'App\\Repository\\UserFollowRepository' => ['privates', 'App\\Repository\\UserFollowRepository', 'getUserFollowRepositoryService', true],
            ...
            'App\\Repository\\CallSignalRepository' => '?',
            'App\\Repository\\ChatRoomMemberRepository' => '?',
            'App\\Repository\\ChatRoomRepository' => '?',
            'App\\Repository\\CommentRepository' => '?',
            'App\\Repository\\CommunityGroupRepository' => '?',
            'App\\Repository\\ContractRepository' => '?',
            'App\\Repository\\DepartmentRepository' => '?',
            'App\\Repository\\GroupMemberRepository' => '?',
            'App\\Repository\\InterviewRepository' => '?',
            'App\\Repository\\JobApplicationRepository' => '?',
            'App\\Repository\\LeaveRepository' => '?',
            'App\\Repository\\MessageRepository' => '?',
            'App\\Repository\\NotificationRepository' => '?',
            'App\\Repository\\OfferRepository' => '?',
            'App\\Repository\\PayrollRepository' => '?',
            'App\\Repository\\PostRepository' => '?',
            'App\\Repository\\ProjectMemberRepository' => '?',
            ...
            'App\\Repository\\TrainingCourseRepository' => '?',
            'App\\Repository\\TrainingEnrollmentRepository' => '?',
            'App\\Repository\\UserFollowRepository' => '?',
