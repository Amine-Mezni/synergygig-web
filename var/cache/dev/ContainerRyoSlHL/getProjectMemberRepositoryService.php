 ...
 */
class getProjectMemberRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjectMemberRepository' shared autowired service.
     *
     * @return \App\Repository\ProjectMemberRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjectMemberRepository.php';

        return $container->privates['App\\Repository\\ProjectMemberRepository'] = new \App\Repository\ProjectMemberRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
