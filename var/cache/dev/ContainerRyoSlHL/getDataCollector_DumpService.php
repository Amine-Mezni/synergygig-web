...
class getDataCollector_DumpService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['data_collector.dump'] = new \Symfony\Component\HttpKernel\DataCollector\DumpDataCollector(($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)), ($container->privates['debug.file_link_formatter'] ?? $container->load('getDebug_FileLinkFormatterService')), 'UTF-8', NULL, NULL, $container->getEnv('bool:default::key:web:default:kernel.runtime_mode:'));
    }
}
