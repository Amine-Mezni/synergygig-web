 ...
 */
class getInterviewRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InterviewRepository' shared autowired service.
     *
     * @return \App\Repository\InterviewRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InterviewRepository.php';

        return $container->privates['App\\Repository\\InterviewRepository'] = new \App\Repository\InterviewRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
