 ...
 */
class getTrainingCourseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrainingCourseRepository' shared autowired service.
     *
     * @return \App\Repository\TrainingCourseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrainingCourseRepository.php';

        return $container->privates['App\\Repository\\TrainingCourseRepository'] = new \App\Repository\TrainingCourseRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
