 ...
 */
class getGroupMemberRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GroupMemberRepository' shared autowired service.
     *
     * @return \App\Repository\GroupMemberRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GroupMemberRepository.php';

        return $container->privates['App\\Repository\\GroupMemberRepository'] = new \App\Repository\GroupMemberRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
