 ...
 */
class getCommunityGroupRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommunityGroupRepository' shared autowired service.
     *
     * @return \App\Repository\CommunityGroupRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommunityGroupRepository.php';

        return $container->privates['App\\Repository\\CommunityGroupRepository'] = new \App\Repository\CommunityGroupRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
