...
class get_ServiceLocator_B4dyivWService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.B4dyivW'])) {
            return $container->privates['.service_locator.B4dyivW'];
        }

        return $container->privates['.service_locator.B4dyivW'] = $instance;
    }
}
