 ...
 */
class getUserFollowRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserFollowRepository' shared autowired service.
     *
     * @return \App\Repository\UserFollowRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserFollowRepository.php';

        return $container->privates['App\\Repository\\UserFollowRepository'] = new \App\Repository\UserFollowRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
