 ...
 */
class getCallSignalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CallSignalRepository' shared autowired service.
     *
     * @return \App\Repository\CallSignalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CallSignalRepository.php';

        return $container->privates['App\\Repository\\CallSignalRepository'] = new \App\Repository\CallSignalRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
