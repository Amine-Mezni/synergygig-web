 ...
 */
class getTrainingCertificateRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrainingCertificateRepository' shared autowired service.
     *
     * @return \App\Repository\TrainingCertificateRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrainingCertificateRepository.php';

        return $container->privates['App\\Repository\\TrainingCertificateRepository'] = new \App\Repository\TrainingCertificateRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
