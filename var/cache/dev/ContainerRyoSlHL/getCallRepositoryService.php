 ...
 */
class getCallRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CallRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CallRepository.php';

        return $container->privates['App\\Repository\\CallRepository'] = new \App\Repository\CallRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
