 ...
 */
class getChatRoomRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChatRoomRepository' shared autowired service.
     *
     * @return \App\Repository\ChatRoomRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChatRoomRepository.php';

        return $container->privates['App\\Repository\\ChatRoomRepository'] = new \App\Repository\ChatRoomRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
