 ...
 */
class getTrainingEnrollmentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrainingEnrollmentRepository' shared autowired service.
     *
     * @return \App\Repository\TrainingEnrollmentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrainingEnrollmentRepository.php';

        return $container->privates['App\\Repository\\TrainingEnrollmentRepository'] = new \App\Repository\TrainingEnrollmentRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
