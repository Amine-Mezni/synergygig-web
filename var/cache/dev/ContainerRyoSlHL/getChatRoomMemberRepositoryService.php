 ...
 */
class getChatRoomMemberRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChatRoomMemberRepository' shared autowired service.
     *
     * @return \App\Repository\ChatRoomMemberRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChatRoomMemberRepository.php';

        return $container->privates['App\\Repository\\ChatRoomMemberRepository'] = new \App\Repository\ChatRoomMemberRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
