 ...
 */
class getPayrollRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PayrollRepository' shared autowired service.
     *
     * @return \App\Repository\PayrollRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PayrollRepository.php';

        return $container->privates['App\\Repository\\PayrollRepository'] = new \App\Repository\PayrollRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
